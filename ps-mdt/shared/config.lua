...
Config.RosterLink = {
    ['police'] = 'https://docs.google.com/spreadsheets/d/1hcRkKXIvnj5DyLokjfL3GFsxwEURL62UXkYmkL94qe4/edit#gid=1048398751',
    ['ambulance'] = '',
    ['bcso'] = '',
    ['doj'] = '',
}
...
Config.Fuel = "ps-fuel" -- "ps-fuel", "lj-fuel"
...
Config.ImpoundLocations = { 
    [1] = vector4(463.51, -1015.23, 28.08, 91.64),
