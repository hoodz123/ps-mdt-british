...
var DispatchNum = 0;
var playerJob = "";
let rosterLink  = "https://docs.google.com/spreadsheets/d/1hcRkKXIvnj5DyLokjfL3GFsxwEURL62UXkYmkL94qe4/edit#gid=1048398751";
...
$(document).ready(() => {
  ...
  $(".manage-incidents-title-holder").on(
    ...
    function () {
      let tempalte =
        "📝 Brief Summary:\n\n[Insert Brief Report Summary Of What Occurred]\n\n🧍 People involved: [Name Here]\n\n🔪 Weapons/Items Confiscated:\n\n· [Insert List Here]\n\n📄 Evidence (link any photos and/or videos if applicable):\n\n [link/s here]\n\n -----\n💸 Fine:\n⌚ Sentence:\n-----";
  ...
  function JobColors(sentJob) {
    if (sentJob) {
      if (PoliceJobs[sentJob] !== undefined) {
        ...
        $(".header-title").html("Metropolitan Police Department");
        ...
        $(".quote-span").html("Working together for a safer London");
        ...
        $(".header-title").html("NHS LONDON AMBULANCE SERVICE");
        $(".quote-span").html(
          "NHS WE ARE HERE TO SAVE LIVES"
        );
        ...
        $(".header-title").html("Ministry Of Justice");
        $(".quote-span").html("Time to Protect Criminals");
        //$(".dmv-nav-item").hide();
        $(".bolo-nav-item").hide();
  ...
  window.addEventListener("message", function (event) {
    ...
    if (eventData.type == "show") {
      ...
      activeUnits.forEach((unit) => {
        ...
        let status = unit.duty == 1 ? "State-1" : 'State-11';
        let statusColor = unit.duty == 1 ? "green-status" : 'red-tag';
